...
const formSchema = z
  .object({
    ...
    specialty: z
      .string()
      .trim()
      .min(1, { message: "A especialidade do médico é obrigatória" }),
    appointmentPrice: z
      .number()
      .min(0, { message: "O preço da consulta é obrigatório" }),
  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          Preencha os campos abaixo para adicionar um novo médico à sua clínica.
        </DialogDescription>
      </DialogHeader>
      <Form {...form}>
